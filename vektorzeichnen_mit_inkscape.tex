...
\begin{frame}[t]
  ...
  \begin{columns}[t]
  	\begin{column}{0.5\textwidth}
  		...
  		\begin{figure}
  		   \centering
  			\includegraphics[width=0.7\textwidth]{\images/marvin_bitter.png}
  	...
  	\textbf{Vektorgrafik}
  		...
  		\begin{figure}
  			\centering
  			\includegraphics[width=0.6\textwidth]{\images/marvin.pdf}
...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\item \textbf{Marvin Bilder} von \textit{Dirty White Paint}, bearbeitet: \href{https://www.youtube.com/user/DirtyWhitePaint}{\texttt{youtube.com}} \par
			\begin{minipage}{\linewidth}
  	            \centering
  	            \includegraphics[width=0.5in]{\images/marvin.pdf}
  	        \end{minipage}
