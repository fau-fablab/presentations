...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Arbeitsfläche 100$\times$60\,cm, bis ca 10\,mm Dicke, Genauigkeit etwa 0,2\,mm
        \item Daten als Vektorzeichnung [.svg/ .pdf] (Inkscape, Corel Draw, ...) oder als Technische Zeichnung [.DXF] (CAD, ...)
    \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Kunststoff: PLA und Kunstharz
        \item Maximale Baugröße ungefähr 20\,$cm^3$ (max. 15\,$cm^3$ SLA)
        \item Nicht alles ist sinnvoll druckbar - vorher nachfragen!
        \item Daten als 3D-Modell [.STL] (PTC Creo, Solid Edge, Siemens NX, ...)
    \end{itemize}
    \begin{center}
    ~\\
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Spezielle Zerspan-/Fräsberatungs Termine (kein OpenLab!)
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Öffnungszeiten: \\Im Semester regelmäßig OpenLab/SelfLab
